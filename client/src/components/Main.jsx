  ...
  return (
    <div className="main">
      <Routes>
        ...
        <Route path="/products" element={<Products productFilteredData={productFilteredData} setProductFilteredData={setProductFilteredData} setProductData={setProductData}/>} />
